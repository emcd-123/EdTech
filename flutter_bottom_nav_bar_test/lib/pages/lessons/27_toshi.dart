...
class LessonToshi extends StatefulWidget {
  const LessonToshi({super.key});

  @override
  State<LessonToshi> createState() => _LessonToshiState();
}

class _LessonToshiState extends State<LessonToshi> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "年"),
