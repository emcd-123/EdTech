...
class LessonShoushou extends StatefulWidget {
  const LessonShoushou({super.key});

  @override
  State<LessonShoushou> createState() => _LessonShoushouState();
}

class _LessonShoushouState extends State<LessonShoushou> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "少々"),
