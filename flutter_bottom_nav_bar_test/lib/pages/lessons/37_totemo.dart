...
class LessonTotemo extends StatefulWidget {
  const LessonTotemo({super.key});

  @override
  State<LessonTotemo> createState() => _LessonTotemoState();
}

class _LessonTotemoState extends State<LessonTotemo> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "とても"),
