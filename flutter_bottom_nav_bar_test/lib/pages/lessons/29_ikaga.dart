...
class LessonIkaga extends StatefulWidget {
  const LessonIkaga({super.key});

  @override
  State<LessonIkaga> createState() => _LessonIkagaState();
}

class _LessonIkagaState extends State<LessonIkaga> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "いかが"),
