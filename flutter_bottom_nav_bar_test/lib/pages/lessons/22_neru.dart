...
class LessonNeru extends StatefulWidget {
  const LessonNeru({super.key});

  @override
  State<LessonNeru> createState() => _LessonNeruState();
}

class _LessonNeruState extends State<LessonNeru> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "寝る"),
