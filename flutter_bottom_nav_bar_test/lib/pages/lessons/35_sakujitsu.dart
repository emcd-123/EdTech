...
class LessonSakujitsu extends StatefulWidget {
  const LessonSakujitsu({super.key});

  @override
  State<LessonSakujitsu> createState() => _LessonSakujitsuState();
}

class _LessonSakujitsuState extends State<LessonSakujitsu> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "昨日"),
