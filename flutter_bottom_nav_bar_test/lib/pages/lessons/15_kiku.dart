...
class LessonKiku extends StatefulWidget {
  const LessonKiku({super.key});

  @override
  State<LessonKiku> createState() => _LessonKikuState();
}

class _LessonKikuState extends State<LessonKiku> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "聞く"),
