...
class LessonAsu extends StatefulWidget {
  const LessonAsu({super.key});

  @override
  State<LessonAsu> createState() => _LessonAsuState();
}

class _LessonAsuState extends State<LessonAsu> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "明日"),
