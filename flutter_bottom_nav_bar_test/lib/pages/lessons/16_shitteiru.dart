...
class LessonShitteiru extends StatefulWidget {
  const LessonShitteiru({super.key});

  @override
  State<LessonShitteiru> createState() => _LessonShitteiruState();
}

class _LessonShitteiruState extends State<LessonShitteiru> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "知っている"),
