...
class LessonKiru extends StatefulWidget {
  const LessonKiru({super.key});

  @override
  State<LessonKiru> createState() => _LessonKiruState();
}

class _LessonKiruState extends State<LessonKiru> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "着る"),
