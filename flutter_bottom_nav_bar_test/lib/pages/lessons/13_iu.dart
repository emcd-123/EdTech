...
class LessonIu extends StatefulWidget {
  const LessonIu({super.key});

  @override
  State<LessonIu> createState() => _LessonIuState();
}

class _LessonIuState extends State<LessonIu> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "言う"),
