...
class LessonShinu extends StatefulWidget {
  const LessonShinu({super.key});

  @override
  State<LessonShinu> createState() => _LessonShinuState();
}

class _LessonShinuState extends State<LessonShinu> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "死ぬ"),
