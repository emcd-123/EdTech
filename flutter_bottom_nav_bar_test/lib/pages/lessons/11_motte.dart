...
class LessonMotte extends StatefulWidget {
  const LessonMotte({super.key});

  @override
  State<LessonMotte> createState() => _LessonMotteState();
}

class _LessonMotteState extends State<LessonMotte> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "持っていく・持ってくる"),
