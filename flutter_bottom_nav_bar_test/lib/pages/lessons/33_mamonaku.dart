...
class LessonMamonaku extends StatefulWidget {
  const LessonMamonaku({super.key});

  @override
  State<LessonMamonaku> createState() => _LessonMamonakuState();
}

class _LessonMamonakuState extends State<LessonMamonaku> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "まもなく"),
