...
class LessonOmou extends StatefulWidget {
  const LessonOmou({super.key});

  @override
  State<LessonOmou> createState() => _LessonOmouState();
}

class _LessonOmouState extends State<LessonOmou> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "思う"),
