...
class LessonAu extends StatefulWidget {
  const LessonAu({super.key});

  @override
  State<LessonAu> createState() => _LessonAuState();
}

class _LessonAuState extends State<LessonAu> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "会う"),
