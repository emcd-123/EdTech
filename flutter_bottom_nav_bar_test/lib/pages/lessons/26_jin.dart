...
class LessonJin extends StatefulWidget {
  const LessonJin({super.key});

  @override
  State<LessonJin> createState() => _LessonJinState();
}

class _LessonJinState extends State<LessonJin> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "人・方"),
