...
class LessonKuru extends StatefulWidget {
  const LessonKuru({super.key});

  @override
  State<LessonKuru> createState() => _LessonKuruState();
}

class _LessonKuruState extends State<LessonKuru> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "来る"),
