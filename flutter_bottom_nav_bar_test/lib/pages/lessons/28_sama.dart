...
class LessonSama extends StatefulWidget {
  const LessonSama({super.key});

  @override
  State<LessonSama> createState() => _LessonSamaState();
}

class _LessonSamaState extends State<LessonSama> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "さん・さま"),
