...
class LessonKonoAida extends StatefulWidget {
  const LessonKonoAida({super.key});

  @override
  State<LessonKonoAida> createState() => _LessonKonoAidaState();
}

class _LessonKonoAidaState extends State<LessonKonoAida> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "この間"),
