...
class LessonUchiSoto extends StatefulWidget {
  const LessonUchiSoto({super.key});

  @override
  State<LessonUchiSoto> createState() => _LessonUchiSotoState();
}

class _LessonUchiSotoState extends State<LessonUchiSoto> {
