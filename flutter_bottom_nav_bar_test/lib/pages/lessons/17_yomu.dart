...
class LessonYomu extends StatefulWidget {
  const LessonYomu({super.key});

  @override
  State<LessonYomu> createState() => _LessonYomuState();
}

class _LessonYomuState extends State<LessonYomu> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "読む"),
