...
class LessonMiru extends StatefulWidget {
  const LessonMiru({super.key});

  @override
  State<LessonMiru> createState() => _LessonMiruState();
}

class _LessonMiruState extends State<LessonMiru> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "見る"),
