...
class LessonSakihodo extends StatefulWidget {
  const LessonSakihodo({super.key});

  @override
  State<LessonSakihodo> createState() => _LessonSakihodoState();
}

class _LessonSakihodoState extends State<LessonSakihodo> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: PageView(
          ...
          children: [
            templateTitlePage(
                context, "assets/irasutoya/study_nihongo.png", "先ほど"),
